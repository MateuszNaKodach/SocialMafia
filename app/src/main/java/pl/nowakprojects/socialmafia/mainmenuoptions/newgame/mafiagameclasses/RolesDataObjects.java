...
public class RolesDataObjects {
    ...
    public static ArrayList<PlayerRole> getTownRolesList(){
        ...
        playerRoles.add(new PlayerRole(R.string.priest,R.string.priestDescription,R.drawable.image_template, PlayerRole.Fraction.TOWN, PlayerRole.ActionType.OnlyZeroNight,160));
